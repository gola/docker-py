...
class ContainerApiMixin(object):
    ...
    @utils.check_resource
    def update_start(self, container, binds=None, port_bindings=None, lxc_conf=None,
              publish_all_ports=None, links=None, privileged=None,
              dns=None, dns_search=None, volumes_from=None, network_mode=None,
              restart_policy=None, cap_add=None, cap_drop=None, devices=None,
              extra_hosts=None, read_only=None, pid_mode=None, ipc_mode=None,
              security_opt=None, ulimits=None, mem_limit=None, cpu_shares=None, cpuset=None):
        ...
        start_config_kwargs = dict(
            ...
            extra_hosts=extra_hosts, read_only=read_only, pid_mode=pid_mode,
            ipc_mode=ipc_mode, security_opt=security_opt, ulimits=ulimits,
            mem_limit=mem_limit, cpu_shares=cpu_shares, cpuset=cpuset
        )
        start_config = None
